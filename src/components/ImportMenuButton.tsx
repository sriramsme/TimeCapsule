...
export default function ImportMenuButton({ onImport }: HeaderProps) {
    ...
    const handleImportJSON = () => {
        triggerFileInput('.json', async (file) => {
            try {
                ...
                if (confirm(`This will replace your current timeline with ${imported.capsules.length} capsule(s). Continue?`)) {
    ...
    return (
        <>
            <div className="mt-2 w-64 bg-white border rounded-lg shadow-lg z-50 py-1 ">
                <button
